...
return new class extends Migration
{
    ...
    {
        DB::statement("ALTER TABLE pharmaceutical_products MODIFY COLUMN status ENUM('uploading_documents', 'pending_review', 'approved', 'rejected', 'active') NOT NULL DEFAULT 'uploading_documents'");
    }
};
