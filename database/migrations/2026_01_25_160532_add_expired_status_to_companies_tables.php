...
return new class extends Migration
{
    ...
    {
        DB::statement("ALTER TABLE local_companies MODIFY COLUMN status ENUM('uploading_documents', 'pending', 'approved', 'active', 'rejected', 'suspended', 'pending_payment') DEFAULT 'uploading_documents'");

        DB::statement("ALTER TABLE foreign_companies MODIFY COLUMN status ENUM('uploading_documents', 'pending', 'approved', 'active', 'rejected', 'suspended', 'pending_payment') DEFAULT 'uploading_documents'");
    }
};
