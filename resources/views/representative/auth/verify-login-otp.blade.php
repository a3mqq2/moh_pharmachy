...
<div class="login-container otp-container">
    ...
    <div class="welcome-section">
        <h2>{{ __('auth.verify_identity') }}</h2>
        <p>{{ __('auth.enter_otp_sent_to') }}</p>
    ...
    <!-- OTP Form -->
    <form method="POST" action="{{ route('verify-login-otp.submit') }}" class="otp-form" dir="rtl" id="otpForm">
        @csrf
        ...
        <button type="submit" class="submit-btn" id="verifyBtn" disabled>
            <span>{{ __('auth.verify_and_login') }}</span>
