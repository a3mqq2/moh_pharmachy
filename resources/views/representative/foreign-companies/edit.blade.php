...
@section('title', __('companies.edit_foreign_company'))
...
<div class="dashboard-container">
    <div class="page-header">
        <div class="page-header-content">
            ...
            <div>
                <h1>{{ __('companies.edit_foreign_company') }}</h1>
                <p>{{ __('companies.edit_foreign_desc') }}: {{ $company->company_name }}</p>
            </div>
        </div>
    </div>
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <select name="entity_type" id="entity_type" class="form-control" required>
                            ...
                            <option value="company" {{ (old('entity_type') ?? $company->entity_type) == 'company' ? 'selected' : '' }}>{{ __('companies.entity_company') }}</option>
                            <option value="factory" {{ (old('entity_type') ?? $company->entity_type) == 'factory' ? 'selected' : '' }}>{{ __('companies.entity_factory') }}</option>
                        </select>
                        @error('entity_type')
                            <span class="error-message">{{ $message }}</span>
                        @enderror
                    ...
                    <div class="form-group">
                        ...
                        <select name="activity_type" id="activity_type" class="form-control" required>
                            ...
                            <option value="medicines" {{ (old('activity_type') ?? $company->activity_type) == 'medicines' ? 'selected' : '' }}>{{ __('companies.activity_medicines') }}</option>
                            <option value="medical_supplies" {{ (old('activity_type') ?? $company->activity_type) == 'medical_supplies' ? 'selected' : '' }}>{{ __('companies.activity_medical_supplies') }}</option>
                            <option value="both" {{ (old('activity_type') ?? $company->activity_type) == 'both' ? 'selected' : '' }}>{{ __('companies.activity_both') }}</option>
                        </select>
                        @error('activity_type')
                            <span class="error-message">{{ $message }}</span>
                        @enderror
            ...
            <div class="step-content" data-step="4">
                ...
                <div class="review-section">
                    ...
                    <div class="review-content">
                        <p class="text-muted">{{ __('companies.review_before_save_note') }}</p>
                    </div>
                </div>
            </div>
