...
@section('title', 'تسجيل صنف دوائي جديد')
...
<div class="dashboard-container">
    <div class="page-header">
        <div class="page-header-content">
            ...
            <div>
                <h1>تسجيل صنف دوائي جديد</h1>
                <p>قم بتعبئة البيانات المطلوبة لتسجيل صنف دوائي جديد</p>
            </div>
        </div>
    </div>
        ...
        <div class="form-section">
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="text" id="pharmaceutical_form" name="pharmaceutical_form" class="form-control @error('pharmaceutical_form') is-invalid @enderror" value="{{ old('pharmaceutical_form') }}" placeholder="مثال: أقراص، كبسولات، شراب..." required>
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="concentration" name="concentration" class="form-control @error('concentration') is-invalid @enderror" value="{{ old('concentration') }}" placeholder="مثال: 500 مجم، 10 مل..." required>
                    @error('concentration')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
            ...
            <div class="form-group" id="other_usage_method_group" style="display: {{ in_array('other', old('usage_methods', [])) ? 'block' : 'none' }};">
                ...
                <input type="text" id="other_usage_method" name="other_usage_method" class="form-control @error('other_usage_method') is-invalid @enderror" value="{{ old('other_usage_method') }}" placeholder="اكتب طريقة الاستعمال الأخرى">
