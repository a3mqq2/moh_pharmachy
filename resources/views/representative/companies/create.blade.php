...
@section('title', 'تسجيل شركة جديدة')

@section('content')
<div class="company-form-container">
    <div class="form-header">
        <h1>تسجيل شركة جديدة</h1>
        <p>يرجى اتباع الخطوات لإتمام التسجيل</p>
    </div>
        ...
        <div class="form-step" data-step="2">
            ...
            <div class="pre-registration-section">
                ...
                <div id="preRegistrationFields" class="pre-registration-fields" style="display: {{ old('is_pre_registered') ? 'block' : 'none' }};">
                    ...
                    <div class="form-group">
                        <small>رقم القيد: <strong id="repCreatePreRegPreview">-</strong></small>
                    </div>
                </div>
            </div>
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <select name="license_type" id="license_type" class="form-control" required>
                        ...
                        <option value="company" {{ old('license_type') == 'company' ? 'selected' : '' }}>شركة</option>
                        <option value="partnership" {{ old('license_type') == 'partnership' ? 'selected' : '' }}>تشاركية</option>
                        <option value="authorized_agent" {{ old('license_type') == 'authorized_agent' ? 'selected' : '' }}>وكيل معتمد</option>
                    </select>
                    @error('license_type')
                        <span class="error-message">{{ $message }}</span>
                    @enderror
                ...
                <div class="form-group">
                    ...
                    <select name="license_specialty" id="license_specialty" class="form-control" required>
                        ...
                        <option value="medicines" {{ old('license_specialty') == 'medicines' ? 'selected' : '' }}>أدوية</option>
                        <option value="medical_supplies" {{ old('license_specialty') == 'medical_supplies' ? 'selected' : '' }}>مستلزمات طبية</option>
                        <option value="medical_equipment" {{ old('license_specialty') == 'medical_equipment' ? 'selected' : '' }}>معدات طبية</option>
                    </select>
