...
<head>
    ...
    <title>{{ __('emails.company_approved_title') }}</title>
...
<body>
    <div class="email-container">
        ...
        <div class="content">
            <h2>{{ __('emails.company_approved_heading') }}</h2>

            <p>{{ __('emails.dear_representative') }}</p>
            <p>{{ __('emails.greeting') }}</p>

            <p>{{ __('emails.company_approved_body') }}</p>
            ...
            <div class="note">
                ...
                <ol>
                    <li>{{ __('emails.company_approved_step_1') }}</li>
                    <li>{{ __('emails.company_approved_step_2') }}</li>
                    <li>{{ __('emails.company_approved_step_3') }}</li>
                    <li>{{ __('emails.company_approved_step_4') }}</li>
                    <li>{{ __('emails.company_approved_step_5') }}</li>
                </ol>
            </div>

            <p><strong>{{ __('emails.important_note') }}</strong> {{ __('emails.company_approved_note') }}</p>
