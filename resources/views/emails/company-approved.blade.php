...
<head>
    ...
    <title>تم قبول طلب تسجيل الشركة</title>
...
<body>
    <div class="email-container">
        ...
        <div class="content">
            <h2>إشعار بقبول طلب التسجيل</h2>

            <p>السيد/ة الممثل المحترم،</p>
            <p>تحية طيبة وبعد،</p>

            <p>يسعدنا إبلاغكم بأنه قد تم قبول طلب تسجيل شركتكم من قبل وزارة الصحة - إدارة الصيدلة .</p>
            ...
            <div class="note">
                ...
                <ol>
                    <li>تم إصدار فاتورة التسجيل لشركتكم</li>
                    <li>الدخول إلى لوحة التحكم وإتمام عملية السداد</li>
                    <li>رفع صورة إيصال الدفع من خلال قسم الفواتير والمدفوعات</li>
                    <li>انتظار مراجعة الإيصال والموافقة عليه من قبل الإدارة</li>
                    <li>بعد الموافقة، سيتم تفعيل الشركة بشكل نهائي</li>
                </ol>
            </div>
