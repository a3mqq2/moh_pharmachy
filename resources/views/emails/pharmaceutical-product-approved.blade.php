...
<head>
    ...
    <title>{{ __('emails.product_approved_title') }}</title>
...
<body>
    <div class="email-container">
        ...
        <div class="content">
            ...
            <p><strong>{{ __('emails.important_note') }}</strong> {{ __('emails.product_approved_note') }}</p>
